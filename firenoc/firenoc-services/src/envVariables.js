const envVariables = {
  ...
  KAFKA_BROKER_HOST: process.env.KAFKA_BROKER_HOST || "release-name-kafka-controller-headless.kafka-kraft:9092",  
  ...
  // default state // IDEA:
  EGOV_DEFAULT_STATE_ID: process.env.EGOV_DEFAULT_STATE_ID || "pg",
  ...
  STATE_SCHEMA_INDEX_POSITION: process.env.STATE_SCHEMA_INDEX_POSITION || 0,
