...
public class ServiceConfiguration {
    ...
    //Tl billing Slab configuration

    @Value("${billingslab.host}")
    private String tlbillingSlabHost;

    @Value("${billingslab.create.path}")
    private String tlbillingSlabCreatepath;

    @Value("${billingslab.host}${billingslab.create.path}")
    private String tlBillingSlabCreateURI;
