...
export const fetchLocalisation = async () => {
    ...
    let localisationResponse = await fetch(`${window.location.origin}/localization/messages/v1/_search?locale=en_IN&tenantId=pb&module=rainmaker-common,rainmaker-bnd`, requestOptions)
