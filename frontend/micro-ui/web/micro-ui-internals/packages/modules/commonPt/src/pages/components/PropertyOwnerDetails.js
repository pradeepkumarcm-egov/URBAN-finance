...
const PropertyOwnerDetails = ({ t, config, onSelect, userType, formData, formState, ownerIndex, setError, clearErrors }) => {
  ...
  const institutionTypeMenu = useMemo(() => {
    ...
    return arraData?.map(
      (e) => e.code?.split(".")?.[1] && { ...e, i18nKey: `COMMON_MASTERS_OWNERSHIPCATEGORY_${e.code?.split(".")?.[1]?.replaceAll(".", "_")}` }
    );
            ...
            {isInstitutionalOwnerType ? (
              <React.Fragment>
                ...
                <CardLabelError style={errorStyle}>
                  {touched?.["institutionName" + index] ? errors?.["institutionName" + index]?.message : ""}
                </CardLabelError>
                ...
                <LabelFieldPair>
                  ...
                  <div className="form-field">
                    <Controller
                      ...
                      render={({ value, onChange, onBlur }) => (
                        <Dropdown
                          selected={institutionTypeMenu?.length === 1 ? institutionTypeMenu[0] : value}
                ...
                <CardLabelError style={errorStyle}>
                  {touched?.["institutionType" + index] ? errors?.["institutionType" + index]?.message : ""}
                </CardLabelError>
                ...
                <CardLabelError style={errorStyle}>
                  {touched?.["altContactNumber" + index] ? errors?.["altContactNumber" + index]?.message : ""}
                </CardLabelError>
                ...
                <CardLabelError style={errorStyle}>
                  {touched?.["mobileNumber" + index] ? errors?.["mobileNumber" + index]?.message : ""}
                </CardLabelError>
