...
//   //     },
//   //     tenantId: data?.state?.searchForm?.city || Digit.ULBService.getCurrentTenantId(),
//   //     fromDate: fromDate || formatDate(data?.state?.searchForm?.fromDateFormatted),
//   //     toDate: toDate || formatDate(data?.state?.searchForm?.toDateFormatted),
//   //     gender: gender || genderMap[data?.state?.searchForm?.gender],
//   //   };
...
//     const tenantId = data?.state?.searchForm?.city || Digit.ULBService.getCurrentTenantId();
//     const fromDate = formatDate(data?.state?.searchForm?.fromDateFormatted);
//     const toDate = formatDate(data?.state?.searchForm?.toDateFormatted);
//     const gender = genderMap[data?.state?.searchForm?.gender] || data?.state?.searchForm?.gender;
...
export const UICustomizations = {
    ...
    preProcess: (data, additionalDetails) => {
      console.log(data,'came to preProcess config')
  ...
  searchDeathConfig: {
    preProcess: (data) => {
      console.log(data, "Data in preProcess: config");
      return data;
    },
