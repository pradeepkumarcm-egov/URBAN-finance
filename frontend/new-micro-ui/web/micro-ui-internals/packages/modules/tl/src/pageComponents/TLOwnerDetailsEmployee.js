          ...
          {typeOfOwner === "INSTITUTIONAL" && (
            <React.Fragment>
                ...
                <div className="field">
                  <Controller
                    ...
                    rules={{
                      ...
                      validate: { pattern: (val) => (/^\w+( +\w+)*$/.test(val) ? true : t("TL_NAME_ERROR_MESSAGE")) },
                    }}
                    render={(props) => (
                      <TextInput
                        t={t}
                        ...
                        onChange={(e) => {
                          if (e != owner?.instituionName && isRenewal)
              ...
              <LabelFieldPair>
                ...
                <div className="field">
                  <Controller
                    ...
                    defaultValue={
                      window.location.href.includes("tl/edit-application-details") || window.location.href.includes("tl/renew-application-details/")
                        ? owner?.subOwnerShipCategory
                        : ""
                    }
                    render={(props) => (
                      <Dropdown
              ...
              <CardLabelError style={errorStyle}>
                {localFormState.touched.subOwnerShipCategory ? errors?.subOwnerShipCategory?.message : ""}
              </CardLabelError>
              ...
              <LabelFieldPair>
                ...
                <div className="field">
                  <Controller
                    ...
                    rules={{
                      required: t("REQUIRED_FIELD"),
                      validate: { pattern: (val) => (/^([6-9]{1}[0-9]{9})$/.test(val) ? true : t("CORE_COMMON_APPLICANT_MOBILE_NUMBER_INVALID")) },
                    }}
                    render={(props) => (
                      <MobileNumber
                        type={""}
                ...
                <div className="field">
                  <Controller
                    ...
                    rules={{
                      /* required: t("REQUIRED_FIELD"), */ validate: {
                        pattern: (val) =>
                          /^$|^[0][1-9][0-9]{9}$|^[1-9][0-9]{9}$/.test(val) ? false : t("CORE_COMMON_APPLICANT_MOBILE_NUMBER_INVALID"),
                      },
                    }}
                    render={(props) => (
                      <MobileNumber
